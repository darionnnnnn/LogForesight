...
2026-07-30 起草；同日第二輪細化，**全部未決事項已拍板**；同日**全部 8 項已實作完成**
（分支 `feature/feedback-round3`，commit fb261d0/6f18728/2662ca5/3df3e00/62f4201/60e2902/7a08c20，
1119 測試綠，尚未合併主線）。實作順序：#7→#3+#6→#5→#4→#1→#2→#8。
來源：使用者實測回饋 8 項（批次/NetIQ 2 項＋Web 6 項）。
