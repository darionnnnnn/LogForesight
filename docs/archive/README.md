...
- [FEEDBACK-30-PLAN.md](FEEDBACK-30-PLAN.md) — 回饋第三十輪：登入失敗誤判分辨（4625/4771/Linux 結構化明細、殘留憑證重試跨日確認制、關聯層/趨勢層/4740 下游修正、密碼噴灑偵測）／NetIQ 探索改良（提早停頁、背景工作化、網段自動分割、掃描粒度）／規則補強（seed v4→v5、升級依 ModifiedBy 分流、既有規則降噪）
