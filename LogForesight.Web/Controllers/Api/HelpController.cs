...
public class HelpController : ControllerBase
{
    ...
    public HelpController(HelpContentService content, HelpQaService qa)
    {
        _content = content;
        _qa = qa;
    }

    /// <summary>manifest＋全部章節內容一次取回（總量 &lt;200KB，不值得做分節載入）</summary>
    [HttpGet("manual")]
    public ApiResponse<HelpManualDto> Manual() => ApiResponse<HelpManualDto>.Ok(_content.GetManual());
