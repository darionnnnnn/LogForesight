...
public class AnalysisSettings
{
    ...
    /// <summary>
    /// 體檢間隔天數（2026-07-20 重設計，取代原「固定星期六全量」，見 docs/archive/HISTORY.md「核心設計決策 B」）。
...
public class SentinelServer
{
    ...
    /// <summary>轄下主機的作業系統（docs/archive/FEEDBACK-12-PLAN.md §4.4），沿用 <see cref="Sentinel.Os"/>
...
public class StorageSettings
{
    ...
    public string ResolveDataRoot() =>
        string.IsNullOrWhiteSpace(DataRoot) ? AppContext.BaseDirectory : DataRoot;
}
